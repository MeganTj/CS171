...
void draw_objects()
{
    ...
    for(int i = 0; i < num_objects; ++i)
    {
         ...
         */
        {
             ...
             */
            glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT, objects[i].ambient_reflect);
            glMaterialfv(GL_FRONT_AND_BACK, GL_DIFFUSE, objects[i].diffuse_reflect);
            glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, objects[i].specular_reflect);
            glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, objects[i].shininess);
