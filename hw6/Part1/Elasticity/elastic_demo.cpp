...
{ 
    ...
    for(int i = 0; i < vertices.size(); i++)
    {
        ...
        vertices[i].vx = (vertices[i].vx + vertices[i].fx * tstep) / 
                        vertices[i].mass;
        vertices[i].vy = (vertices[i].vy + vertices[i].fy * tstep) / 
                        vertices[i].mass;
        vertices[i].x = vertices[i].x + vertices[i].vx * tstep;
        vertices[i].y = vertices[i].y + vertices[i].vy * tstep;
